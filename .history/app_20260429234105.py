...
def predict():
    try:
        ...
        # Ensure the feature names match the CSV columns EXACTLY
        # If your notebook used different names, update this list
        feature_order = [
            'person_age', 'person_income', 'person_home_ownership', 
            'person_emp_length', 'loan_intent', 'loan_amnt', 
            'loan_int_rate', 'loan_percent_income', 
        ...
        input_df = input_df[feature_order] # Force correct column order
        ...
        return jsonify({
            ...
            'shap_contributions': shap_vals[0].tolist(),
            'feature_names': feature_order
        })
    except Exception as e:
        print(f"ERROR: {str(e)}") # This will show in your terminal/CMD
